...
public record SendQuizJob(long ChatId, string? ChatTitle, string Question, long UserId, string UserFirstName, long UserChatId, List<OptionWithToken> OptionsWithTokens, string? SessionId = null);
public record SendQuizCallbackJob(long UserId, long ChatId, int MessageId, long MessageChatId, string? SessionId = null);
...
public record KickUserJob(long ChatId, long UserId);
public record SendMessageVerfJob(long ChatId, string Text);
